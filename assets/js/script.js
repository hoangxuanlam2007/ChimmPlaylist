...
function showInfo(){
  var elms = document.getElementsByClassName("info-box");
...
function closeInfo() {
  var x = document.getElementById("closeInfoBtn");
  var y = document.getElementById("infoBtn");
  var z = document.getElementById("info-box")
  if (x.style.display === "block") {
    x.style.display = "none";
    y.style.display = "block";
    z.style.display = "none"
...
output.innerHTML = 'Âm lượng:' + ' ' + slider.value + '%'; 
/* Cập nhật giá trị hiện tại của volume-control + "%" */
slider.oninput = function() {
  output.innerHTML = 'Âm lượng:' + ' ' + this.value + '%';
}
